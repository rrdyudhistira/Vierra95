          ...
          <ul className="cards">
            ...
            <li>
              <a href="https://bit.ly/hoodievierra" className="card">
                <img src="/main_wall.jpg" className="card__image" alt="" />
            ...
            <li>
              <a href="https://bit.ly/goldvierra" className="card">
                <img src="/katalog.jpg" className="card__image" alt="" />
                <div className="card__overlay">
                  <div className="card__header">
                    <svg className="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>
                    {/* <img class="card__thumb" src="/logo_header.png" alt="" /> */}
            ...
            <li>
              <a href="https://bit.ly/lightstickvierra" className="card">
                <img src="/katalog2.jpg" className="card__image" alt="" />
                <div className="card__overlay">
                  <div className="card__header">
                    <svg className="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>
        ...
        <div className="img3-wrapper">
          ...
          <div className="footer">
            ...
            <div className="sosmed">
              ...
              {/* <Link
                href="https://www.youtube.com/channel/UCqwdqKpSkPInXMhRcaIFxRA"
                passHref
              >
                <Image src="/yt.png" width={45} height={48}></Image>
              </Link> */}
              <Link
                href="https://bit.ly/wakontak1"
                passHref
              >
                <Image src="/wa.png" width={50} height={50}></Image>
              </Link>
            </div>
